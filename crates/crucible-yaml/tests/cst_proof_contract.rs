...
#[test]
fn pure_parser_block_mapping_continuation_transition_is_exact_and_total() {
    proof {
        let token = CompletedTokenView {
            kind: CompletedTokenKind::PlainScalar,
            start_line_number: 0,
        ...
        reveal(crucible_yaml::cst::cst_empty_builder_spec);
        reveal(crucible_yaml::cst::cst_node_task_spec);
        reveal(crucible_yaml::cst::cst_step_block_mapping_state_six_spec);
        reveal(crucible_yaml::cst::cst_step_node_internal_error_spec);
        reveal(crucible_yaml::cst::cst_task_extend_node_end_spec);
        reveal_with_fuel(crucible_yaml::cst::cst_skip_trivia_spec, 2);
        reveal(crucible_yaml::cst::cst_task_set_cursor_spec);
        ...
        reveal(crucible_yaml::cst::cst_machine_resume_task_spec);
        reveal(crucible_yaml::cst::cst_resume_parse_task_spec);
        let result = crucible_yaml::cst::cst_step_block_mapping_state_six_spec(
            Seq::empty(),
            seq![token],
            task,
            machine,
        ...
        assert(next_machine.tasks[0].cursor == 1);
        assert(next_machine.tasks[0].node_token_end == 1);
        let invalid = crucible_yaml::cst::ParseTaskView { state: 5, ..task };
        assert(crucible_yaml::cst::cst_step_block_mapping_state_six_spec(
            Seq::empty(),
            seq![token],
            invalid,
            machine,
...
#[test]
fn pure_parser_block_mapping_completed_value_transition_is_exact_and_total() {
    proof {
        let key = CompletedTokenView {
            kind: CompletedTokenKind::PlainScalar,
            start_line_number: 0,
        ...
        reveal(crucible_yaml::cst::cst_empty_builder_spec);
        reveal(crucible_yaml::cst::cst_node_task_spec);
        reveal(crucible_yaml::cst::cst_step_block_mapping_state_three_spec);
        reveal(crucible_yaml::cst::cst_step_node_internal_error_spec);
        reveal(crucible_yaml::cst::cst_machine_take_completed_spec);
        reveal(crucible_yaml::cst::cst_take_completed_node_spec);
        reveal(crucible_yaml::cst::cst_task_set_cursor_spec);
        ...
        reveal(crucible_yaml::cst::cst_machine_resume_task_spec);
        reveal(crucible_yaml::cst::cst_resume_parse_task_spec);
        let result = crucible_yaml::cst::cst_step_block_mapping_state_three_spec(
            seq![key, colon, value],
            task,
            machine,
            builder,
        ...
        assert(next_machine.tasks[0].state == 6);
        assert(next_machine.tasks[0].cursor == 3);
        assert(next_machine.tasks[0].entry_token_end == 3);
        assert(next_machine.tasks[0].pending_mapping.len() == 1);
        assert(next_machine.tasks[0].pending_mapping[0].key_node_index == 0);
        assert(next_machine.tasks[0].pending_mapping[0].value_node_index == 1);
        assert(next_machine.tasks[0].pending_mapping[0].token_start == 0);
        ...
        assert(next_machine.tasks[0].pending_mapping[0].mapping_value_token == Some(1));
        let missing = crucible_yaml::cst::ParseMachineView { completed: None, ..machine };
        assert(crucible_yaml::cst::cst_step_block_mapping_state_three_spec(
            seq![key, colon, value],
            task,
            missing,
            builder,
...
#[test]
fn pure_parser_block_mapping_value_decision_transition_is_exact_and_total() {
    proof {
        let key = CompletedTokenView {
            kind: CompletedTokenKind::PlainScalar,
            start_line_number: 0,
        ...
        let empty = crucible_yaml::cst::cst_empty_builder_spec(2, limits, 2);
        let key_node = CstNodeView {
            kind: CstNodeKind::Scalar,
            style: CstNodeStyle::Plain,
            token_start: 0,
        ...
        reveal(crucible_yaml::cst::cst_empty_builder_spec);
        reveal(crucible_yaml::cst::cst_node_task_spec);
        reveal(crucible_yaml::cst::cst_step_block_mapping_state_two_spec);
        reveal(crucible_yaml::cst::cst_step_node_internal_error_spec);
        reveal_with_fuel(crucible_yaml::cst::cst_skip_trivia_spec, 3);
        reveal(crucible_yaml::cst::cst_task_set_cursor_spec);
        reveal(crucible_yaml::cst::cst_empty_node_spec);
        ...
        reveal(crucible_yaml::cst::cst_machine_resume_task_spec);
        reveal(crucible_yaml::cst::cst_resume_parse_task_spec);
        let result = crucible_yaml::cst::cst_step_block_mapping_state_two_spec(
            Seq::empty(),
            seq![key, colon],
            task,
            machine,
        ...
        assert(next_machine.tasks.len() == 1);
        assert(next_machine.tasks[0].state == 6);
        assert(next_machine.tasks[0].cursor == 2);
        assert(next_machine.tasks[0].entry_token_end == 2);
        assert(next_machine.tasks[0].pending_mapping.len() == 1);
        assert(next_machine.tasks[0].pending_mapping[0].key_node_index == 0);
        assert(next_machine.tasks[0].pending_mapping[0].value_node_index == 1);
        assert(next_machine.tasks[0].pending_mapping[0].mapping_value_token == Some(1));
        let invalid = crucible_yaml::cst::ParseTaskView { state: 1, ..task };
        assert(crucible_yaml::cst::cst_step_block_mapping_state_two_spec(
            Seq::empty(),
            seq![key, colon],
            invalid,
            machine,
...
#[test]
fn pure_parser_block_mapping_entry_decision_transition_is_exact_and_total() {
    proof {
        let key = CompletedTokenView {
            kind: CompletedTokenKind::PlainScalar,
            start_line_number: 0,
        ...
        reveal(crucible_yaml::cst::cst_empty_builder_spec);
        reveal(crucible_yaml::cst::cst_node_task_spec);
        reveal(crucible_yaml::cst::cst_step_block_mapping_state_zero_spec);
        reveal(crucible_yaml::cst::cst_step_node_internal_error_spec);
        reveal_with_fuel(crucible_yaml::cst::cst_skip_trivia_spec, 3);
        reveal(crucible_yaml::cst::cst_task_set_cursor_spec);
        reveal(crucible_yaml::cst::cst_task_begin_keyed_entry_spec);
        reveal(crucible_yaml::cst::cst_find_mapping_value_on_line_spec);
        reveal_with_fuel(crucible_yaml::cst::cst_find_mapping_value_on_line_from_spec, 3);
        reveal(crucible_yaml::cst::cst_task_set_colon_spec);
        reveal(crucible_yaml::cst::cst_task_set_state_spec);
        reveal(crucible_yaml::cst::cst_machine_resume_task_spec);
        reveal(crucible_yaml::cst::cst_resume_parse_task_spec);
        reveal(crucible_yaml::cst::cst_machine_push_task_spec);
        reveal(crucible_yaml::cst::cst_push_parse_task_spec);
        let result = crucible_yaml::cst::cst_step_block_mapping_state_zero_spec(
            Seq::empty(),
            seq![key, colon],
            task,
            machine,
        ...
        assert(next_builder == builder);
        assert(next_machine.tasks.len() == 2);
        assert(next_machine.tasks[0].kind == crucible_yaml::cst::ParseTaskKind::BlockMapping);
        assert(next_machine.tasks[0].state == 1);
        assert(next_machine.tasks[0].entry_token_start == 0);
        assert(next_machine.tasks[0].colon_token == 1);
        assert(next_machine.tasks[1] == crucible_yaml::cst::cst_node_task_spec(0, 1, false, 4));
        let invalid = crucible_yaml::cst::ParseTaskView { state: 1, ..task };
        assert(crucible_yaml::cst::cst_step_block_mapping_state_zero_spec(
            Seq::empty(),
            seq![key, colon],
            invalid,
            machine,
...
#[test]
fn pure_parser_dispatch_is_exact_and_rejects_invalid_frame_states() {
    proof {
        let limits = crucible_yaml::CstLimitsView {
            max_documents: 1,
            max_nodes: 1,
        ...
        reveal(crucible_yaml::cst::cst_machine_store_completed_spec);
        reveal(crucible_yaml::cst::cst_store_completed_node_spec);
        let result = crucible_yaml::cst::cst_dispatch_parse_task_spec(
            Seq::empty(),
            Seq::empty(),
            task,
            machine,
        ...
        let invalid = crucible_yaml::cst::ParseTaskView {
            kind: crucible_yaml::cst::ParseTaskKind::FlowSequence,
            state: 9,
            ..task
        };
        assert(crucible_yaml::cst::cst_dispatch_parse_task_spec(
            Seq::empty(),
            Seq::empty(),
            invalid,
            machine,
