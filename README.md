...
| Bug-finding engines and target adapters | One Linux local CLI execution adapter is operational; inspection, hard oracles, findings, replay, corpus mutation, minimization, native fuzzers, and the remaining target/platform adapters are pending breadth |
