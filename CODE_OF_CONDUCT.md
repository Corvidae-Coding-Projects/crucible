...
[confidential reporting form](https://github.com/Corvidae-Coding-Projects/crucible/security/advisories/new).
Start the report title with `[CODE OF CONDUCT]`. Reports will be reviewed by project maintainers
who are not directly involved in the incident whenever possible.
